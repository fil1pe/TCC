...
}{fig:protocolo_rede}{KUROSE; ROSS, 2013}

Na Figura \ref{fig:protocolo_rede}, tem-se representado um protocolo de redes em que os círculos são estados de espera, e as transições nas arestas, eventos -- neste caso, procedimentos computacionais. A representação supracitada é uma evidência do caráter de SED do protocolo. A figura é um diagrama de estados, que será introduzido mais adiante.

\hl{FALAR DE AUTOMATOS E REDES DE PETRI}
