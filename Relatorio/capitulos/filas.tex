...
Além de entender a redução de problemas, é interessante observar aplicações que as duas propriedades supracitadas nesta seção proporcionam. É sobre isso que a subseção \ref{subsec:aplicacoes} versa adiante.
