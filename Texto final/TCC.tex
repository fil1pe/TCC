...
\usepackage{minted} % para escrever códigos do Coq
\setminted[coq]{
    breaklines=true,
    encoding=utf8
}
...
\include{capitulos/coq}
\include{capitulos/afd}
\include{capitulos/seds}
\include{capitulos/relacionados}
\include{capitulos/tangivel}
\include{capitulos/produtor-consumidor}
\include{capitulos/detectavel}
